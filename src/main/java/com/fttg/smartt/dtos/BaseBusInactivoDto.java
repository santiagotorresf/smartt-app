 ...
 * @author storres
 */
public class BaseBusInactivoDto {
    ...
    public BaseBusInactivoDto(Integer idCooperativa, Integer idUnidad, String cedula, String ruc, String nombre, String correo, String telefono, String direccion, String cooperativa, Integer externalIdCooperativa, Integer externalIdBus, String placa, String disco, String marca, Integer anio, String capacidad) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 71 * hash + Objects.hashCode(this.idCooperativa);
        hash = 71 * hash + Objects.hashCode(this.disco);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaseBusInactivoDto other = (BaseBusInactivoDto) obj;
