...
public class BaseBusDto {
    ...
    public BaseBusDto(Integer idCooperativa, Integer idUnidad, String cedula, String ruc, String nombre, String correo, String telefono, String direccion, String cooperativa, Integer externalIdCooperativa, Integer externalIdBus, String placa, String disco, String marca, Integer anio, String capacidad) {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 89 * hash + Objects.hashCode(this.idCooperativa);
        hash = 89 * hash + Objects.hashCode(this.disco);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final BaseBusDto other = (BaseBusDto) obj;
